...
export default function Toolbar({ selected = null, onSelect }: Props) {
                ...
                {tools.map((t) => {
                    ...
                    return (
                        <button
                            ...
                            onDragEnd={() => onSelect(t.label)}
                            className={`py-2 px-3 rounded text-sm border flex items-center gap-2 ${t.color} ${isActive ? "ring-2 ring-sky-500" : ""}`}
